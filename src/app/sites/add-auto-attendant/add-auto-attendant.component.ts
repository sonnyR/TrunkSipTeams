...
@Component({
  selector: 'app-add-auto-attendant',
  templateUrl: './add-auto-attendant.component.html',
  styleUrls: ['./add-auto-attendant.component.css'],
  
})
export class AddAutoAttendantComponent implements OnInit {
  ...
  @ViewChild('shadule') shadule: ElementRef;
...
this.listMonth = [
  ...
  {name : 'Décembre',value : 'DECEMBER'},
    ...
    this.registerAutoAttendantForm = this.formBuilder.group({
      ...
      tb_businessSchedule:['',Validators.required],
      tb_businessScheduleHoliday:[''],
      ...
      tb_businessExtensionEnabled:[false],
      tb_Recurence:["Aucun"],
      tb_action_HO_0:['EXIT'],
      tb_action_HO_1:[''],
      tb_action_HO_2:[''],
      ...
      tb_action_HO_etoile:[''],
      tb_action_HO_diese:[''],
      tb_afterExtensionEnabled:[false],
      tb_transferNumber_0:[''],
      tb_transferNumber_1:[''],
      tb_transferNumber_2:[''],
      tb_transferNumber_3:[''],
      ...
      tb_transferNumber_8:[''],
      tb_transferNumber_9:[''],
      tb_transferNumber_etoile:[''],
      tb_transferNumber_diese:[''],
      tb_action_AHO_0:['EXIT'],
      tb_action_AHO_1:[''],
      tb_action_AHO_2:[''],
      tb_action_AHO_3:[''],
      tb_action_AHO_4:[''],
      ...
      tb_action_AHO_8:[''],
      tb_action_AHO_9:[''],
      tb_action_AHO_etoile:[''],
      tb_action_AHO_diese:[''],
      tb_transferNumber_AHO_0:[''],
      tb_transferNumber_AHO_1:[''],
      tb_transferNumber_AHO_2:[''],
      tb_transferNumber_AHO_3:[''],
      tb_transferNumber_AHO_4:[''],
      tb_transferNumber_AHO_5:[''],
      tb_transferNumber_AHO_6:[''],
      tb_transferNumber_AHO_7:[''],
      tb_transferNumber_AHO_8:[''],
      tb_transferNumber_AHO_9:[''],
      tb_transferNumber_AHO_etoile:[''],
      tb_transferNumber_AHO_diese:[''],
      tb_businessGreetingType:['DEFAULT'],
      tb_afterGreetingType:['DEFAULT'],
...
sched.events = [];
 ...
 this.webexServices.CreateAutoattendantAndShcedule(scheduleSvi, this.orgId,this.locationId).subscribe(data => {
  if (data != null && data["status"] == "success") {
    this.toastr.success("l'auto attendant "  + scheduleSvi.autoAttendant.name + " est ajouté avec succés") 
       this.close();
  }
  else {
    var str: string = data["message"];
